...
public class ActivityWelcomeBindingImpl extends ActivityWelcomeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.btn_skip, 1);
        sViewsWithIds.put(R.id.tv_welcome, 2);
        sViewsWithIds.put(R.id.tv_food_hub, 3);
        sViewsWithIds.put(R.id.tv_message, 4);
        sViewsWithIds.put(R.id.tv_have_account, 5);
        sViewsWithIds.put(R.id.btn_sign_in, 6);
        sViewsWithIds.put(R.id.btn_start, 7);
        sViewsWithIds.put(R.id.btn_facebook, 8);
        sViewsWithIds.put(R.id.btn_google, 9);
        sViewsWithIds.put(R.id.tv_sign_in, 10);
        sViewsWithIds.put(R.id.view_left_bar, 11);
        sViewsWithIds.put(R.id.view_right_bar, 12);
    }
    // views
    @NonNull
